...
export const NoticeBar = ({ message, link }: NoticeBarProps) => {
	return (
		<div className="text-amber-900 px-4 py-3 border-b border-yellow-200 flex w-full whitespace-nowrap shadow-sm items-center justify-center overflow-hidden from-yellow-50 to-amber-50 bg-linear-to-r dark:text-amber-100 dark:border-yellow-800 dark:from-yellow-900/30 dark:to-amber-900/30">
