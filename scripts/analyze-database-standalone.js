...
async function main() {
	try {
		...
		markdown += `## 索引规范\n\n`;
		markdown += `### 必需索引\n\n`;
		markdown += `1. **users.email** - 唯一索引\n   \`\`\`javascript\n   { email: 1 }\n   \`\`\`\n\n`;
		markdown += `2. **analysis_requests.sha1_mode** - 复合索引（用于去重查询）\n   \`\`\`javascript\n   { sha1: 1, mode: 1 }\n   \`\`\`\n\n`;
		markdown += `3. **analysis_requests.timestamp** - 普通索引（用于时间排序）\n   \`\`\`javascript\n   { timestamp: -1 }\n   \`\`\`\n\n`;
		markdown += `4. **api_keys.orderNumber** - 唯一索引\n   \`\`\`javascript\n   { orderNumber: 1 }\n   \`\`\`\n\n`;
		markdown += `5. **api_keys.token** - 唯一索引\n   \`\`\`javascript\n   { token: 1 }\n   \`\`\`\n\n`;
		markdown += `6. **email_verification_codes.email_type_used** - 复合索引\n   \`\`\`javascript\n   { email: 1, type: 1, used: 1 }\n   \`\`\`\n\n`;
		markdown += `7. **sessions.session** - 唯一索引\n   \`\`\`javascript\n   { session: 1 }\n   \`\`\`\n\n`;
		markdown += `8. **daily_usage.dayKey_type_key** - 复合唯一索引\n   \`\`\`javascript\n   { dayKey: 1, type: 1, key: 1 }\n   \`\`\`\n\n`;
		...
		const filePath = path.join(process.cwd(), ".cursor", "rules", "database.mdc");
