    ...
    <div ref={listRef} className="space-y-6">
      <div className="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-end">
        <Select value={visibility} onValueChange={(value) => { void handleVisibilityChange(value as HistoryVisibilityOption); }}>
          <SelectTrigger className="bg-white/80 w-full dark:bg-slate-900/80 sm:w-[180px]">
        ...
        <Select value={sort} onValueChange={(value) => { void handleSortChange(value as HistorySortOption); }}>
          <SelectTrigger className="bg-white/80 w-full dark:bg-slate-900/80 sm:w-[220px]">
          ...
          <div className="flex flex-col gap-3 sm:flex-row sm:items-center">
            <div className="flex gap-2 items-center">
              <Input
                ...
                disabled={isLoading}
                className="bg-white/80 w-24 dark:bg-slate-900/80"
              />
              <Button
                variant="outline"
                size="sm"
