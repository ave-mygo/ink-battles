    ...
    <div className="space-y-4">
      ...
      <Card className="border-0 bg-white/80 shadow-lg transition-all backdrop-blur-sm hover:shadow-xl">
        ...
        <CardContent className="space-y-4">
          ...
          {activePromotion && (
            <div className="text-emerald-800 p-4 border border-emerald-100 rounded-lg bg-emerald-50 flex gap-3 items-start dark:text-emerald-200 dark:border-emerald-900/40 dark:bg-emerald-950/30">
              <Percent className="mt-0.5 shrink-0 h-4 w-4" />
